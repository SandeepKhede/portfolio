                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
                        ...
                        >
                            ...
                            <span className="text-white/60 group-hover:text-white transition-colors text-lg">Gmail</span>
                        </a>
                        ...
                        <a
                            href="https://github.com/SandeepKhede"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group flex flex-col items-center gap-4 hover:scale-105 transition-transform"
                        >
                            <div className="w-20 h-20 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-white/10 transition-colors">
                                <svg role="img" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-white">
                            ...
                            <span className="text-white/60 group-hover:text-white transition-colors text-lg">GitHub</span>
                        </a>
                    </div>
                </motion.div>
            </div>
